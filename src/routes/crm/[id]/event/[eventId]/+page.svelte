<script>
  ...
  let activeTab = '400pax';
  
  const tabs = ['400pax', '600pax', '800pax'];
  
  const venueOptions = ['Studio Kencana', 'Grand Ballroom', 'Royal Hall', 'Paradise Garden'];
  const paxOptions = ['400', '600', '800', '1000'];
      ...
      <div class="bg-white rounded-lg shadow-lg p-8">
        ...
        <div class="border-b border-gray-200 mb-6">
          <nav class="flex space-x-4">
            {#each tabs as tab}
              <button
                class="px-4 py-2 font-medium border-b-2 transition-colors {activeTab === tab ? 'border-amber-600 text-amber-600' : 'border-transparent text-gray-500 hover:text-gray-700'}"
        ...
        <div class="space-y-8">
          ...
          <section>
            <div class="grid grid-cols-2 gap-6">
              <div>
                <div class="flex items-center gap-4 mb-4">
                  <h2 class="text-lg font-bold text-gray-800">Entertainment</h2>
                  <div class="flex items-center gap-2">
                    <label class="text-sm text-gray-600">Vendor</label>
                    <select bind:value={entertainmentVendor} class="px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-amber-500">
                      <option value="">Select vendor</option>
                      <option value="vendor1">Vendor 1</option>
                      <option value="vendor2">Vendor 2</option>
                    </select>
              ...
              <div>
                <div class="flex items-center gap-4 mb-4">
                  <h2 class="text-lg font-bold text-gray-800">Wedding Organizer</h2>
                  <div class="flex items-center gap-2">
                    <label class="text-sm text-gray-600">Vendor</label>
                    <select bind:value={entertainmentWeddingOrganizer} class="px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-amber-500">
                      <option value="">Select vendor</option>
                      <option value="vendor1">Vendor 1</option>
                      <option value="vendor2">Vendor 2</option>
                    </select>
